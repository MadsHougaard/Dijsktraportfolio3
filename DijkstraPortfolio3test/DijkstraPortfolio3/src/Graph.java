...
public class Graph {
    ...
    public Pair<Integer, Map<Vertex,Vertex> > ShortestDistance(Vertex source, Vertex zink)
    {
        ...
        while (UnvisitedMap.size() > 0) {
            ...
            for(Edge edge : currentVertex.getOutEdges()) {
                ...
                int neighbourDistance = currentDistance + edge.distance; // lav vores distance til nabo ved at finde vores
                ...
                } //hvis nabo distance er mindre end distance
    ...
    // Returner Vertex med korteste distance på en vilkårlig liste (Map)
